...
python run.py --model BertFC --save_by_step True --patience 1000 --init_weight True --task_name init_weight
python run.py --model BertCNN --save_by_step True --patience 1000 --init_weight True --task_name init_weight
python run.py --model BertRNN --save_by_step True --patience 1000 --init_weight True --task_name init_weight
python run.py --model BertRCNN --save_by_step True --patience 1000 --init_weight True --task_name init_weight
